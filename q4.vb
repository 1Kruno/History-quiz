Public Class q4
    ...
    Private Sub q4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Q_count = 3
        lblscore.Text = "Your score " & score
        lblcorrectanswer.Text = "Correct answer is " & correct_answer(3)
        Timer1.Enabled = True
        txtanswer.Focus()
        counter = 20
        lblqno.Text = "Question number " & numbers(3)
        lblanswera.Text = answera(3)
        lblanswerb.Text = answerb(3)
        lblanswerc.Text = answerc(3)
        lblanswerd.Text = answerd(3)
        If user = "tester" Then
