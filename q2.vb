Public Class q2
    ...
    Private Sub q2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Q_count = 1
        lblscore.Text = "Your score " & score
        lblcorrectanswer.Text = "Correct answer is " & correct_answer(1)
        Timer1.Enabled = True
        txtanswer.Focus()
        counter = 20
        lblqno.Text = "Question number " & numbers(1)
        lblanswera.Text = answera(1)
        lblanswerb.Text = answerb(1)
        lblanswerc.Text = answerc(1)
        lblanswerd.Text = answerd(1)
        If user = "tester" Then
    ...
    Private Sub cmhelp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmhelp.Click
        On Error Resume Next
        frmhelp.Show()
