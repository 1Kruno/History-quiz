Public Class q10
    ...
    Private Sub cmdsubmit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdsubmit.Click
        ...
        MsgBox("Correct answer is C. Thank you for playing! Your final score is:" & score & "/10")
        frmresult.Show()
    ...
    Private Sub q10_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        lblcorrectanswer.Text = "Correct answer is " & correct_answer(9)
        Timer1.Enabled = True
        txtanswer.Focus()
        counter = 20
        lblqno.Text = "Question number " & numbers(9)
        lblanswera.Text = answera(9)
        lblanswerb.Text = answerb(9)
        lblanswerc.Text = answerc(9)
        lblanswerd.Text = answerd(9)
        If user = "tester" Then
