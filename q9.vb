Public Class q9
    ...
    Private Sub q9_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Q_count = 8
        lblscore.Text = "Your score " & score
        lblcorrectanswer.Text = "Correct answer is " & correct_answer(8)
        Timer1.Enabled = True
        txtanswer.Focus()
        counter = 20
        lblqno.Text = "Question number " & numbers(8)
        lblanswera.Text = answera(8)
        lblanswerb.Text = answerb(8)
        lblanswerc.Text = answerc(8)
        lblanswerd.Text = answerd(8)
        If user = "tester" Then
