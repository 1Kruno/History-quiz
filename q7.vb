Public Class q7
    ...
    Private Sub q7_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Q_count = 6
        lblscore.Text = "Your score " & score
        lblcorrectanswer.Text = "Correct answer is " & correct_answer(6)
        Timer1.Enabled = True
        txtanswer.Focus()
        counter = 20
        lblqno.Text = "Question number " & numbers(6)
        lblanswera.Text = answera(6)
        lblanswerb.Text = answerb(6)
        lblanswerc.Text = answerc(6)
        lblanswerd.Text = answerd(6)
        If user = "tester" Then
