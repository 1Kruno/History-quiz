Public Class q6
    ...
    Private Sub cmdsubmit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdsubmit.Click
        ...
        MsgBox("Correct answer is D. Your score so far:" & score)
        q7.Show()
    ...
    Private Sub q6_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        lblcorrectanswer.Text = "Correct answer is " & correct_answer(5)
        Timer1.Enabled = True
        txtanswer.Focus()
        counter = 20
        lblqno.Text = "Question number " & numbers(5)
        lblanswera.Text = answera(5)
        lblanswerb.Text = answerb(5)
        lblanswerc.Text = answerc(5)
        lblanswerd.Text = answerd(5)
        If user = "tester" Then
    ...
    Private Sub txtanswer_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtanswer.TextChanged
        ...
        If (answer_selected = "D") Or (answer_selected = "d") Then
            score = score + 1
            lblscore.Text = "Your score " & score
